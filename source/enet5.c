...
__attribute__((section (".enet_test"))) __attribute__((aligned(64))) enet_rx_bd_struct_t rx_desc[2][ENET_RXBD_NUM];
__attribute__((section (".enet_test"))) __attribute__((aligned(64))) enet_tx_bd_struct_t tx_desc[2][ENET_TXBD_NUM];

__attribute__((section (".enet_test"))) __attribute__((aligned(64))) int8_t rx_buff[2][ENET_RXBD_NUM][ENET_RXBUFF_SIZE];
